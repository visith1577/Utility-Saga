...
<head>
    ...
    <title>Electricity Regional admin Due Payments</title>
...
<div class="search-option">
    <div class="bar-search-button">
        <div class="searchbar" style="margin-top: 12.5vh">
            <form id="searchForm" method="get" action="<%= request.getContextPath() %>/electricity/regional-admin/due-payment">
                <label for="nic"></label>
        ...
        <div class="customerdetails">
            ...
            <div class="table-container">
                <table class="table">
                    ...
                    <c:if test="${empty requestScope.electricityOverdueBills}">
                        <tr>
                            <td colspan="12">No complaints found</td>
                        </tr>
                    </c:if>
                    <c:if test="${not empty requestScope.electricityOverdueBills}">
                        <c:forEach items="${requestScope.electricityOverdueBills}" var="bill">
