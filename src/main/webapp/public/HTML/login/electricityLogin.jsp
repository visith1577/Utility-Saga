    ...
    <body>
        ...
        <div class="container">
            <aside class="side-panel">
                ...
                <img src="<%= request.getContextPath() %>/public/resources/electricity_login.png" width="400px" alt="utility-saga">
            </aside>
            <%--            <div class="empty-div">--%>
            <%--            </div>--%>
            <section class="login">
                <form action="${pageContext.request.contextPath}/elogin" method="post" class="login-form">
                    ...
                    <a href="<%= request.getContextPath() %>/public/HTML/login/forget-password-electricity.jsp" class="fgt-pwd">
                        Forget Password
                    </a>
