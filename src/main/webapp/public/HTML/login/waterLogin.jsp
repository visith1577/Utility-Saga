    ...
    <body>
        ...
        <div class="container">
            <aside class="side-panel">
                ...
                <img src="<%= request.getContextPath() %>/public/resources/water_login.png" width="400px" alt="utility-saga">
            </aside>
            <%--            <div class="empty-div">--%>
            <%--            </div>--%>
            <section class="login">
                <form action="${pageContext.request.contextPath}/water-login" method="post" class="login-form">
