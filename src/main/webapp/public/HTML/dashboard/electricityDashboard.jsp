<%-- Created by IntelliJ IDEA. User: visithkumarapperuma Date: 2023-10-31 Time: 19:52 To change this template use File |
    ...
    <%@ page contentType="text/html;charset=UTF-8" %>
        ...
        <head>
            ...
            <link href="<%= request.getContextPath() %>/public/CSS/login/user/electricitydashbaord.css"
                rel="stylesheet">
            <link href="<%= request.getContextPath() %>/public/CSS/login/user/electricity_navbar_sidebar.css"
                rel="stylesheet">
        </head>
        ...
        <body>
            <div class="wrapper">
                ...
                <div class="top_navbar">
                    ...
                    <div class="top_menu">
                        <div class="logo">
                            <img alt="Utility Saga" height="50px"
                                src="<%= request.getContextPath() %>/public/images/utility_saga.svg">
                        </div>
                        <ul>
                            <li><a href="#">
                                    <img alt="Cart" src="<%= request.getContextPath() %>/public/images/cart.svg"
                                        class="item1">
                                </a></li>
                            <li><a href="#">
                                    <img alt="Notification"
                                        src="<%= request.getContextPath() %>/public/images/notification-line.svg"
                                        class="item2">
                                </a></li>
                            <li><a href="#">
                ...
                <div class="content-middle">
                    <div class="sidebar" id="sidebar">
                        <ul>
                            <li class="list_button"><a href="electricityDashboard.jsp">
                                    <span class="icon"><img alt="home"
                                            src="<%= request.getContextPath() %>/public/images/home-outline.svg" /></span>
                            ...
                            <li class="list_button"><a href="../electricity-service.html">
                                    <span class="icon"><img alt="service"
                                            src="<%= request.getContextPath() %>/public/images/service-plan.svg" /></span>
                                    <span class="title">Service<img alt="service" class="right_arrow" height="20px"
                                            src="../../images/arrow-right-s-line.svg" width="20px" /></span>
                                </a></li>
                            <li class="list_button"><a href="../electricity-service.html">
                                    <span class="icon"><img alt="bills"
                                            src="<%= request.getContextPath() %>/public/images/bill.svg" /></span>
                            ...
                            <li class="list_button"><a href="../electricity-analysis.html">
                                    <span class="icon"><img alt="analysis"
                                            src="<%= request.getContextPath() %>/public/images/report.svg" /></span>
                                    <span class="title">Analysis<img alt="service" class="right_arrow" height="20px"
                                            src="../../images/arrow-right-s-line.svg" width="20px" /></span>
                                </a></li>
                            <li class="list_button"><a href="../electricity-iot.html">
                                    <span class="icon"><img alt="report"
                                            src="<%= request.getContextPath() %>/public/images/iot.svg" /></span>
                                    <span class="title">IOT Devices<img alt="service" class="right_arrow" height="20px"
                                            src="../../images/arrow-right-s-line.svg" width="20px" /></span>
                                </a></li>
                            <li class="list_button"><a href="../settings.html">
                                    <span class="icon"> <img alt="settings"
                                            src="<%= request.getContextPath() %>/public/images/settings-outline.svg" /></span>
                                ...
                                <li class="list_button"><a href="./electricity-contact.html">
                                    <span class="icon"> <img alt="settings" src="<%= request.getContextPath() %>/public/images/call.svg" /></span>
                    ...
                    <div class="intro">
                        ...
                        <img alt="Electricity Board"
                            src="<%= request.getContextPath() %>/public/images/electricity_board.png"><br><br>
                        <p>
                    ...
                    <div class="about">
                        ...
                        <img src="<%= request.getContextPath() %>/public/images/MinistryofPower&Energy.png"
                            alt="Ministry of Power & Energy">
                    ...
                    <div class="contact-us">
                        ...
                        <div class="notification">
                            <h2>Notifications</h2>
                            <div class="powercut">
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Inventore sapiente,
                                    repellat fugiat
