...
<div class="main-container">
    ...
    <header class="block">
        <ul class="header-menu horizontal-list">
            <li>
                <a class="header-menu-tab" href="#2"><span class="icon fontawesome-home scnd-font-color"></span>Home</a>
            </li>
            <li>
                <a class="header-menu-tab" href="#3"><span class="icon fontawesome-bell scnd-font-color"></span>Notifications</a>
    ...
    <div class="left-container container">
        <div class="menu-box block"> <!-- MENU BOX (LEFT-CONTAINER) -->
            ...
            <ul class="menu-box-menu">
                <li>
                    <a class="menu-box-tab" href="#8"><span class="icon entypo-home scnd-font-color"></span>Home<div class="menu-box-number">3</div></a>
                </li>
                <li>
                    <a class="menu-box-tab" href="#6"><span class="icon fontawesome-bell scnd-font-color"></span>Notifications<div class="menu-box-number">24</div></a>
                </li>
                <li>
                ...
                <li>
                    <a class="menu-box-tab" href="#12"><span class="icon entypo-bag scnd-font-color"></span>Store</a>
                </li>
                <li>
