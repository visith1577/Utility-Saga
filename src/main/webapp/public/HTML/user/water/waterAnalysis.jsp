        ...
        <div class="main-content">
            <section class="search component electricity">
                ...
                <div class="select-box">
                    <div class="options-container">
                        <c:forEach var="entry" items="${requestScope.water_account_list}">
                            <div class="option">
                                <input
                                        type="radio"
                                        class="radio"
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="#">
                                ...
                                <span id="kwh-val" class="title-nav visible">Units consumed: </span>
                            </a>
                        </li>
                        <li>
                            <a href="#">
            ...
            <div class="stats bills item">
                ...
                <div class="top-selling stats-box">
                    <form action="<%=request.getContextPath()%>/user/water-analytics" method="post" class="stats-box budget">
...
<script src="<%= request.getContextPath() %>/public/JS/waterAnalysis.js"></script>
</body>
</html>
