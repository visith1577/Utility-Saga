...
@WebServlet("/electricity/regional-admin/pwd-reset")
public class PasswordResetElectricityRegional extends HttpServlet{
    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try {
            ...
            ElectricityAdminImpl userDao = new ElectricityAdminDAO();
