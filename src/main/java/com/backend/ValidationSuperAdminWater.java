...
@WebServlet("/super-admin/water/validation")
public class ValidationSuperAdminWater extends HttpServlet {
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,  IOException {
        ...
        try {
            ...
            if (region != null) {
                boolean isRegionExists = validationDao.isRegionExistsWater(region);
                Gson gson1 = new Gson();
            ...
            if (email != null) {
                boolean isEmailExists = validationDao.isEmailExistsWater(email);
                Gson gson2 = new Gson();
            ...
            if (empid != null) {
                boolean isEmpIdExists = validationDao.isEmpIDExistsWater(empid);
                Gson gson3 = new Gson();
