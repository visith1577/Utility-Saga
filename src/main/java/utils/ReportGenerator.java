...
public class ReportGenerator {
    ...
    public String dailyReportElectricity(String account_no, int total_units, int target_units, int monthly_budget) {
    ...
    public String dailyReportWater(String account_no, int total_units, int target_units, int monthly_budget) {
        ChatLanguageModel model = AnthropicChatModel.withApiKey(dotenv.get("CLAUDE_KEY"));
