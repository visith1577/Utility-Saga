...
@WebFilter(
        urlPatterns = {"/public/HTML/electricity/regionalAdmin/*", "/public/HTML/pages/*", "/public/HTML/login/*", "/electricity/regional-admin/user-accounts/*", "/electricity/admin/pwd-reset/*"},
